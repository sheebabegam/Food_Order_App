...
export default function Dellme_Menu() {
  ...
  // const myproduct = localStorage.getItem("myproduct", JSON.stringify(product));
  var myproduct = localStorage.getItem("myproduct", JSON.stringify(myproduct));
  var myproduct_details = JSON.parse(myproduct);
  ...
  const addcart = (product, e) => {
    ...
    localStorage.setItem("myproduct", JSON.stringify(product, e));
    console.log(myproduct_details.menu_id);

    // if (myproduct_details.menu_id === product.menu_id) {
    //   console.log('same id');
    //   setButtonText(true);
    // }

    //   console.log(e);
    //   console.log(added.menu_id)
    // if(added.menu_id == e) {
